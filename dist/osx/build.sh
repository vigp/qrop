...
macdeployqt Qrop.app -qmldir=$BUILD_DIR/desktop/qml -verbose=3 -executable="${APP_NAME}.app/Contents/MacOS/${APP_NAME}"
tree Qrop.app
appdmg dist/osx/DiskImage/layout.json Qrop.dmg
